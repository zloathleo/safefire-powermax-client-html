                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6">
                            <div className="card card-stats">
                                ...
                                <div className="card-footer">
                                    <div className="stats">
                                        <i className="fa fa-tag text-danger"></i> <a href="#pablo">Get More Space...</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="card card-stats">
                                ...
                                <div className="card-footer">
                                    <div className="stats">
                                        <i className="fa fa-tag"></i> Last 24 Hours
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="card card-stats">
                                ...
                                <div className="card-footer">
                                    <div className="stats">
                                        <i className="fa fa-tag"></i> Tracked from Github
                        </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="card card-stats">
                                ...
                                <div className="card-footer">
                                    <div className="stats">
                                        <i className="fa fa-tag"></i> Just Updated
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <div className="card">
                                ...
                                <div className="card-footer">
                                    <div className="stats">
                                        <i className="fa fa-tag"></i> updated 4 minutes ago
                        </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-md-4">
                            <div className="card">
                                ...
                                <div className="card-footer">
                                    <div className="stats">
                                        <i className="fa fa-tag"></i> campaign sent 2 days ago
                        </div>
                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div className="checkbox">
                                                                <label>
                                                                    <input type="checkbox" name="optionsCheckboxes" defaultChecked={true} />
                                                                </label>
                                                            </div>
                                                        </td>
